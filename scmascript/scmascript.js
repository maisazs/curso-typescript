...
saudacao();
const falarCom = (pessoa) => console.log('Olá ' + pessoa); //quando tem apenas um parâmetro não há necessidade de colocar-lo entre parênteses, porém se há necessidade de definir o tipo de parâmetro, é necessario colocar os parênteses. 
falarCom('João');
// this
